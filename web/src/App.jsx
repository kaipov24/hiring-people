...
function Hero({ user, isCandidate, isManager, isAdmin, page, showAuth, setPage, appHealth }) {
  ...
  const text = publicHero
    ? "Платформа в Кыргызстане, где люди с инвалидностью публикуют резюме, а рекрутеры и работодатели находят сотрудников по навыкам, специализации, городу и формату работы."
    : isAdmin
      ? page === "adminUsers"
  ...
  return (
    <section className="public-section">
      ...
      <div className="seo-copy">
        <p>
          inclusive-hire помогает рекрутерам и работодателям найти сотрудника с инвалидностью в Кыргызстане,
          а людям с инвалидностью — опубликовать резюме и показать опыт, навыки, специализацию, город и
          удобный формат работы.
        </p>
        <p>
          Платформа подходит для поиска кандидатов и сотрудников с инвалидностью по всему Кыргызстану:
          Айдаркен, Балыкчы, Баткен, Базар-Коргон, Бишкек, Чолпон-Ата, Манас, Джалал-Абад,
          Кадамжай, Кант, Кара-Балта, Каракол, Кара-Куль, Кара-Суу, Кайынды, Кемин, Кербен,
          Кочкор-Ата, Кок-Жангак, Кызыл-Кыя, Майлуу-Суу, Нарын, Ноокат, Орловка, Ош, Узген,
          Раззаков, Шопоков, Сулюкта, Талас, Таш-Кумыр, Токмок, Токтогул и удаленный формат.
        </p>
      </div>
